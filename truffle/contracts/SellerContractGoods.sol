...
function isBlocked(bytes32 _productId) public view returns (bool) {
        return blocklist[_productId];
    }

    function getAllPurchaseIds() public view returns (bytes32[] memory) {
 return purchaseIds;
    }
