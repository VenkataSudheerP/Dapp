...
const Upload =  () => {
   ...
   let response2;
     ...
     //let usedPurchaseIds = ["0xba17e771dd0c4e918392af09c9f2b26687222047c892ec12ec6810939bba0f08"];
     ...
     const sellercontract = new web3.eth.Contract(abii,"0x2EcE9C3125a99C31258Fc7b22E9CCC3808B0711D     ");
     const val = false;
     ...
     await sellercontract.methods.verify(purchaseId).call().then(result => {
      if(usedPurchaseIds.includes(purchaseId)){
        ...
        contract.methods.addPurchase(purchaseId,username,purchasePrice,purchaseDate,sellerName,purchaserName,response1.data.IpfsHash,response2.data.IpfsHash,response3.data.IpfsHash,response4.data.IpfsHash,val).send({from : "0x5BD00ebD9881e6946af29F89218a510AB42EdFBb"})
